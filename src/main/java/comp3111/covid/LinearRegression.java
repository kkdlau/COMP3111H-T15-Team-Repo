...
/**
 * The {@code comp3111.covid.LinearRegression} class performs a simple linear regression
...
public class LinearRegression {
     ...
     * @return an instance of comp3111.covid.LinearRegression.
     */
    static LinearRegression fromSeries(XYChart.Series<? extends Number, ? extends Number> data) {
        double[] x = new double[data.getData().size()];
        double[] y = new double[data.getData().size()];
        int i = 0;
        for (var d : data.getData()) {
            x[i] = d.getXValue().doubleValue();
            y[i] = d.getYValue().doubleValue();
            i++;
        }
    ...
    public XYChart.Series<Float, Float> generateMockData() {
        ...
        series.getData().add(new XYChart.Data<>((float) 0, y0));
        series.getData().add(new XYChart.Data<>((float) max_x, y1));
    ...
    public String toString() {
        ...
        s.append(String.format("Death = %.2f * Cases + %.2f", slope(), intercept()));
